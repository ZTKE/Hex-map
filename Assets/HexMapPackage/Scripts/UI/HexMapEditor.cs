...
public partial class HexMapEditor : MonoBehaviour
{
	...
	HexMountainMode activeMountainMode;
	...
	public void ShowGrid(bool visible)
	{
		...
		if (hexGrid)
		{
			hexGrid.SetGridVisible(visible);
		}
		gridVisible = visible;
	}
	...
	void HandleLandformShortcuts()
	{
		...
		{
			activeLandform = HexLandform.Plateau;
			SelectTool(EditorTool.Relief);
		}
	}
	...
	void EditCell(HexCell cell)
	{
		...
		switch (activeTool)
		{
			...
			case EditorTool.Relief:
				...
				if (activeLandform == HexLandform.Mountain) cell.SetMountainMode(activeMountainMode);
				break;
