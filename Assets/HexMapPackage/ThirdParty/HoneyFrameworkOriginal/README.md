...
The pre-HF material textures remain available under
`Assets/HexMapPackage/Materials/Terrain` and
`Assets/HexMapPackage/ThirdParty/HoneyFrameworkTerrain`; none were deleted or
overwritten.
