...
{
	if (landform > 1.5 && landform < 2.5) return HF_ORIGINAL_MOUNTAIN;
	if (landform > 0.5 && landform < 1.5) return HF_ORIGINAL_HILL;
	// Plateau uses the biome's flat HF panel; Near adds its continuous height.
